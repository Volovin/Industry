...
namespace Industry.World.Roads
{
    ...
    public class RoadNode : RoadBase
    {
        ...
        {
            //if (m_blocks[index].activeSelf != active)
            //    m_blocks[index].SetActive(active);
        ...
        public void AddLink(params RoadNode[] roads)
        {
            ...
            foreach (var road in roads)
            {
                ...
                if (!this.m_isEntrance && m_blocks[i1])//m_blocks[i1].activeSelf)
                {
        ...
        public void RemoveLink(RoadNode road)
        {
            ...
            if (!m_isEntrance && !m_blocks[i1])//!m_blocks[i1].activeSelf)
            {
