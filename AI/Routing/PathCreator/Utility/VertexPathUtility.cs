...
{
    internal static class VertexPathUtility
    {
        ///
        internal class BezierPath
        {
            ...
            public Vector3[] GetPointsInSegment(int n)
            {
        ...
        internal static PathSplitData SplitBezierPathByAngleError(BezierPath bezierPath, float maxAngleError, float minVertexDst, float accuracy) //Path.BezierPath bezierPath
        {
